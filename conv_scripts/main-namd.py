...
########################################################
#
#   This code is for explicit NAMD (non-NBRA) calculations
#   with many trajectories, but minimal data saving
#
########################################################
...
dyn_general = { "nsteps":15000, "ntraj":1000, "nstates":NSTATES,
                ...
                "constrained_dofs":[],
                "mem_output_level":2,
                "properties_to_save":[ "timestep", "time", "se_pop_adi", "sh_pop_adi", "Epot_ave", "Ekin_ave", "Etot_ave"],
                "icond":0
              }
...
dyn_params.update({ "prefix":F"NAMD-model{model_indx}-method{method_indx}-icond{icond_indx}", 
                    "prefix2":F"NAMD-model{model_indx}-method{method_indx}-icond{icond_indx}" })
print(F"Computing NAMD-model{model_indx}-method{method_indx}-icond{icond_indx}")    
...
pref = F"NAMD-model{model_indx}-method{method_indx}-icond{icond_indx}"
...
plot_params = { "prefix":pref, "filename":"mem_data.hdf", "output_level":3,
                ...
                "what_to_plot":["energies", "se_pop_adi", "se_pop_dia", "sh_pop_adi"] 
              }
