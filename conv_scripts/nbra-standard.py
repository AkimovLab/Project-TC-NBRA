...
from recipes import dish_nbra, fssh_nbra, fssh_nbra_tc, fssh_nbra_nac_tc, fssh2_nbra, gfsh_nbra, ida_nbra, mash_nbra, msdm_nbra


import argparse
parser = argparse.ArgumentParser(description='TC-NBRA calculations with Libra...')
parser.add_argument('--istate_traj', type=int) 
parser.add_argument('--params_option', type=int) 
...
dyn_general = { "nsteps":NSTEPS, "ntraj":500, "nstates":NSTATES, "dt":5.0,
...
#####################
#params_option = 9
params_option = args.params_option
#####################
...
if method_indx==0:
    ...
    fssh_nbra_nac_tc.load(dyn_general); prf = F"FSSH_NAC_TC-{istate_traj}-{params_option}"; dyn_general.update({ "properties_to_save":prop1})  # FSSH_NAC_TC
