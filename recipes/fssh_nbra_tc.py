...
def load(dyn_general):
    ...
    #dyn_general.update({"hop_acceptance_algo":0, "momenta_rescaling_algo":40 })  # accept and rescale based on total energy, reverse on frustrated
    dyn_general.update({"hop_acceptance_algo":40, "momenta_rescaling_algo":40 })  # accept and rescale based on the tcnbra_ekin variable
    ...
    #=========== Activate TC NBRA approach ===================
    dyn_general.update( {"thermally_corrected_nbra":1  } )
    ...
    #dyn_general.update( { "decoherence_times_type":1,2 "decoherence_C_param": 1.0, "decoherence_eps_param":0.1 } )  # EDC + default params
